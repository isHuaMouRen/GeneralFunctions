...
namespace HuaZi.Library.InputManager
{
    public class InputManager
    {
        public static class Mouse
        {
            ...
            /// 设置鼠标坐标
            /// </summary>
            /// <param name="pos">坐标, Tuple类型</param>
            public static void SetMousePosition((int X, int Y) pos)
            {
        ...
        public static class Keyboard
        {
            ...
            public async static void KeyPress(byte key, int delay = 50)
            {
                KeyDown(key);
